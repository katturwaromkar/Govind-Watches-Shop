...
async function main() {
  ...
  const productsData = [
    ...
    {
      name: "Titan Raga Viva Rose Gold Mother of Pearl Dial Watch",
      slug: "titan-raga-viva-rose-gold-pearl-dial",
      sku: "TT-2608WM01",
      description: "Designed for modern women, featuring a authentic mother-of-pearl dial with Swarovski crystal markers and a rose gold mesh bracelet.",
      shortDescription: "Titan Raga luxury rose gold women's watch with Swarovski crystals.",
      price: 6295,
      mrp: 7495,
      discount: 16,
      gender: "WOMEN",
      ...
      strapMaterial: "Rose Gold Plated Mesh",
      ...
      specs: [
        { key: "Brand", value: "Titan Raga" },
        { key: "Glass Material", value: "Mineral Glass" },
        { key: "Dial Crystals", value: "Swarovski Elements" },
      ],
    },
    {
      name: "Wildhorn Handcrafted RFID Slim Bi-Fold Leather Wallet",
      slug: "wildhorn-handcrafted-rfid-slim-leather-wallet",
      sku: "WH-WAL-092",
      description: "Slim bi-fold wallet made from 100% genuine hunter leather with built-in RFID blocking shield, 6 card slots, and dual currency compartments.",
      shortDescription: "Genuine leather RFID blocking bi-fold wallet for men.",
      price: 899,
      mrp: 1499,
      discount: 40,
      gender: "MEN",
      ...
      specs: [
        { key: "Material", value: "100% Top Grain Hunter Leather" },
        { key: "Protection", value: "RFID Shielding (13.56 MHz)" },
        { key: "Capacity", value: "6 Card Slots + 2 Cash Compartments" },
      ],
    },
    {
      name: "Govindraj Executive Waterproof Laptop Backpack 30L",
      slug: "govindraj-executive-waterproof-laptop-backpack-30l",
      sku: "GV-BAG-30L",
      description: "Heavy-duty 30L laptop backpack with padded 15.6-inch laptop compartment, USB charging port, waterproof nylon shell, and ergonomic shoulder padding.",
      shortDescription: "Waterproof 30L laptop backpack for college & travel.",
      price: 1899,
      mrp: 2999,
      discount: 36,
      gender: "UNISEX",
      ...
      specs: [
        ...
        { key: "Laptop Size", value: "Fits up to 15.6 Inch" },
        { key: "Material", value: "High-density Waterproof Nylon" },
      ],
    },
    {
      name: "Fossil Townsman Automatic Skeleton Leather Watch",
      slug: "fossil-townsman-automatic-skeleton-leather",
      sku: "FS-ME3098",
      description: "Exquisite automatic self-winding mechanical watch with transparent skeleton dial revealing gears, encased in stainless steel with amber leather strap.",
      shortDescription: "Fossil mechanical skeleton automatic watch with leather strap.",
      price: 15495,
      mrp: 18495,
      discount: 16,
      gender: "MEN",
